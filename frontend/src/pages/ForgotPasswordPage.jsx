            ...
            {!isSubmitted ? (
                ...
                <div className="text-center">
                    ...
                    <p className="text-gray-300">
                        If an account exists with for {email}, we will send you a link to reset your password.
                    </p>
                </div>
            ) }
        </div>
        <div className="px-8 py-4 bg-gray-90 bg-opacity-50 flex justify-center">
